...
//  BankeyRoma
//
//  Created by Ramazan Amangeldin on 23/02/2023.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    var currentVC: UIViewController {
        didSet {
            ...
            doneButton.isHidden = !(index == pages.count - 1) // show if not last page
        }
    }
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Bankey is faster, easier to use, and has a brand new look and fell that will make you feel like you are back in the 80s.")
